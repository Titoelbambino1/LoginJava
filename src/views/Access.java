...
public class Access extends javax.swing.JFrame {
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        String realUserName = "Titoelbambino1";
        String realPassword = "Titoelbambino123";
        ...
        if(userName.equals(realUserName) && userPass.equals(realPassword)){
            JOptionPane.showMessageDialog(this,"BIENVENDIO/A!",
                    "ACCESO", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Nombre de usuario / Clave incorrecta!",
